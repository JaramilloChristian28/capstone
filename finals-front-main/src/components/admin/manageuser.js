...
export default function DoctorManagement() {
    ...
    const submitEditedUser = async (e) => {
        e.preventDefault();
        const { id, name, email, role, nfc_id, password } = editUser;
        ...
        try {
            let result = await fetch(`http://127.0.0.1:8000/api/users/${id}`, {
                ...
                body: JSON.stringify({ name, email, role, nfc_id, password })
            });
    ...
    const submitNewUser = async (e) => {
        e.preventDefault();
        const { name, email, role,nfc_id, password, password_confirmation } = newUser;
        ...
        try {
            let result = await fetch('http://127.0.0.1:8000/api/users', {
                ...
                body: JSON.stringify({ name, email, role,nfc_id, password, password_confirmation })
            });
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="form-group">
                                        <label>NFC ID:</label>
                                        <input type='password' className='form-control' name='nfc_id' value={editUser.nfc_id || ''} onChange={handleInputChange} required />
                                    </div>
                                    <div className="form-group">
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="form-group">
                                        <label>NFC ID:</label>
                                        <input type='password' className='form-control' name='nfc_id' value={newUser.nfc_id || ''} onChange={handleNewUserInputChange} required />
                                    </div>
                                    <div className="form-group">
                                        <label>Password:</label>
